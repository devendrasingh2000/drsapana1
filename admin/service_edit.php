...
// Check if editid is set in GET request
if(isset($_GET['editid'])) {
    ...
    if($selectquery) {
        ...
        $oldimage = $row['image']; // Existing image path in database
        ...
        if(isset($_POST['submit'])){
            ...
            // Update record in database with new or old image name
            $sql = "UPDATE services SET name = '$name', meta_title ='$meta_title', description ='$description', meta_description='$meta_description', meta_keyword='$meta_keyword', image ='$newimage' WHERE id = '$id'";
